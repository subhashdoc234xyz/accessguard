          ...
          >
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-200 pb-6">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <a
                  href={`/api/report/${jobState.job_id}`}
                  className="bg-indigo-600 text-white hover:bg-indigo-705 bg-indigo-600 hover:bg-indigo-700 rounded-xl px-4 py-2.5 text-xs font-semibold tracking-wide transition shadow-sm flex items-center gap-2 cursor-pointer"
                >
